...
<body>
        ...
        <div id="main">
            <div class="page-heading">
                ...
                <section class="section">
                    <form action="{{ route('update-promo-brand-voucher', $promo->id) }}" class="form form-vertical"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="container">
                            <h3 class="mb-2">Update Brand Voucher</h3>
                            <p class="mb-3">
                                Update Brand Voucher Sekarang Untuk Menarik Minat Pembeli.
                    ...
                    <!-- Brand Modal remains the same as in the new code -->
    ...
    <script type="text/jav'ascript" src="https://cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script>
                    ...
                    <tr ${rowClass}>
                        <td>
                            <input type="checkbox" name="product_ids[]" 
                                value="${product.id}" class="select-item" ${disabled}>
                        </td>
                        <td>
