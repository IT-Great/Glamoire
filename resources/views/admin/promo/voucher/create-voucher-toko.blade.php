...
<head>
    ...
    <style>
        ...
        Menyembunyikan ikon sort pada kolom pertama #table1 th:first-child .dataTable-sorter {
            display: none;
        }
    </style>
</head>
...
<body>
        ...
        <div id="main">
            <div class="page-heading">
                ...
                <section class="section">
                    <form action="{{ route('store-promo-shop-voucher') }}" class="form form-vertical" method="POST"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @else
                                                            <small class="text-muted" style="font-size: 14px;">Choose
                                                                the brand
                                                                or add
                                                                new one</small>
                                                        @endif
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Object to store discount types for each product
            const productTypes = {};

            // Function to handle individual product discounts
            const initializeProductDiscounts = () => {
                $('.custom-dropdown-item-product').off('click').on('click', function(e) {
                    ...
                    discountInput.val(''); // Reset input when changing type
                    discountTypeInput.val(type); // Update hidden input value
                });
            ...
            function reinitializeComponents() {
                ...
                $('.custom-dropdown-item-product').on('click', function(e) {
                    e.preventDefault();
                    var type = $(this).data('type');
                    var productId = $(this).data('product-id');
                    var symbolSpan = $(`#formatSymbolProduct-${productId}`);
                ...
                // Reinitialize discount handlers
                initializeProductDiscounts();
            }

            // Initialize discount handlers on page load
            initializeProductDiscounts();
        });
    </script>
