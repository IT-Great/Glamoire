        ...
        <div id="main">
            <div class="page-title">
                <div class="row mb-2">
                    <div class="col-12">
                        <div class="page-title">
                            <h3 class="mb-2">Produk Terikirim</h3>
                            <p>Kelola semua produk yang sudah terkirim ke pelanggan pada halaman ini</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="alert alert-info alert-dismissible fade show mt-3" role="alert">
                ...
                Produk sudah terkirim. Anda dapat melihat informasi pengiriman dan status pesanan di halaman ini.
                Silakan pantau status atau lakukan tindakan lanjutan jika diperlukan.
