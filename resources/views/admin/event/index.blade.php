...
<body>
    <div id="app">
        ...
        <div id="main">
            ...
            <!-- PERBAIKAN: Menampilkan Error Validasi (Agar Anda tahu kenapa gagal save) -->
            @if ($errors->any())
                <div class="alert alert-danger alert-dismissible show fade">
                    <h5 class="alert-heading text-white"><i class="bi bi-exclamation-triangle-fill"></i> Gagal Menyimpan
                        Data!</h5>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <h4 class="mb-0 d-flex align-items-center"><i
                                        class="bi bi-calendar-event-fill me-2"></i> Daftar Event</h4>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (!empty($event->images) && count($event->images) > 0)
                                                    <img src="{{ Storage::url($event->images[0]) }}" alt="Event"
                                                        class="event-image-thumbnail">
                                                    @if (count($event->images) > 1)
                                                        <span
                                                            class="badge bg-dark ms-1">+{{ count($event->images) - 1 }}</span>
                                                    @endif
                                                @else
                                                    <span class="text-muted" style="font-size: 0.8rem;">Tidak ada
                                                        gambar</span>
                                                @endif
                                            </td>
                                            <td>
                                                <div class="action-buttons">
                                                    ...
                                                    <form action="{{ route('admin.event.destroy', $event->id) }}"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="button"
                                                            class="btn btn-sm btn-danger d-inline-flex align-items-center delete-event"
                                                            data-id="{{ $event->id }}">
                                                    ...
                                                    <form action="{{ route('admin.event.update', $event->id) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group mb-3">
                                                                <label class="form-label text-dark fw-bold">Judul Event
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 form-group mb-3">
                                                                    <label class="form-label text-dark fw-bold">Tanggal
                                                                        Pelaksanaan <span
                                                                ...
                                                                <div class="col-md-6 form-group mb-3">
                                                                    <label class="form-label text-dark fw-bold">Season
                                                                        / Tema (Opsional)</label>
                                                                    <input type="text" class="form-control"
                                                                        name="season" value="{{ $event->season }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group mb-3">
                                                                <label class="form-label text-dark fw-bold">Status
                                                                    <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label text-dark fw-bold">Deskripsi
                                                                    Acara</label>
                                                                <textarea name="description" class="form-control" rows="5">{{ $event->description }}</textarea>
                                                            </div>
                                                            <div class="form-group mb-3">
                                                                <label class="form-label text-dark fw-bold">Gambar
                                                                    Dokumentasi</label>
                                                                    ...
                                                                    <div class="d-flex gap-2 mt-3 flex-wrap">
                                                                        @foreach ($event->images as $img)
                                                                            <img src="{{ Storage::url($img) }}"
                                                                                alt="Preview"
                                                                                style="height: 70px; border-radius: 8px; border: 1px solid #ddd; object-fit: cover;">
                                                                        @endforeach
                                                                    </div>
                                                                @endif
                                                            </div>
            ...
            <!-- CREATE MODAL (Pastikan enctype="multipart/form-data" ada di sini) -->
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.event.store') }}" method="POST"
                            ...
                            <div class="modal-body">
                                <div class="form-group mb-3">
                                    <label class="form-label text-dark fw-bold">Judul Event <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="title" required
                                        placeholder="Contoh: Glamoire Beauty Exhibition">
                                </div>
                                <div class="row">
                                    <div class="col-md-6 form-group mb-3">
                                        <label class="form-label text-dark fw-bold">Tanggal Pelaksanaan <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="season"
                                            placeholder="Contoh: Summer Collection 2026">
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label text-dark fw-bold">Status <span
                                            class="text-danger">*</span></label>
                                    <select name="status" class="form-select" required>
                                ...
                                <div class="form-group mb-3">
                                    <label class="form-label text-dark fw-bold">Gambar Dokumentasi <span
                                            class="text-danger">*</span></label>
                                    <input type="file" class="form-control" name="images[]" multiple
                                        accept="image/*" required>
                                    <small class="text-muted d-block mt-1">Tahan tombol CTRL (Windows) atau CMD (Mac)
                                        untuk memilih banyak gambar sekaligus.</small>
                                </div>
                            </div>
                            <div class="modal-footer">
