...
<body>
    ...
    <script
        src="[https://cdn.jsdelivr.net/npm/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js](https://cdn.jsdelivr.net/npm/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js)">
    </script> --}}
        ...
        $(document).ready(function() {
            ...
            if (flashSaleCheckbox) {
                flashSaleCheckbox.addEventListener('change', function() {
                    document.getElementById('flash_sale_settings').style.display = this.checked ? 'block' :
                        'none';
                });
            }
