    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @if (in_array(Auth::user()->role, ['admin', 'superadmin']))
                    <!-- menu-menu lain hanya untuk admin/superadmin -->
                    <li class="sidebar-item has-sub {{ Request::is('product-admin*') || Request::is('stock-product-admin*') ? 'active' : '' }}">
                        <a href="#" class='sidebar-link'>
                            <i class="bi bi-bag-fill"></i>
                            <span>Produk</span>
                        </a>
                        ...
                        <ul class="submenu">
                            <li class="submenu-item {{ Request::is('product-admin') ? 'active' : '' }}">
                                <a href="{{ route('index-product-admin') }}">Produk</a>
                            </li>
                            <li class="submenu-item {{ Request::is('stock-product*') ? 'active' : '' }}">
                                <a href="{{ route('index-stock-product-admin') }}">Stok Produk</a>
                            </li>
                        </ul>
                    </li>
