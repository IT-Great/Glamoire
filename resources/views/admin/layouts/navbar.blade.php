    ...
    <header class="mb-2">
        <nav class="navbar navbar-expand navbar-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-4 nav-notifications">
                        <!-- Stock Notifications (Elemen HTML-nya di-comment, jadi JS error jika tidak dilindungi) -->
                    ...
                    <div class="dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-expanded="false" style="text-decoration: none;">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="user-img d-flex align-items-center">
                                    <div class="avatar avatar-md">
                                        <!-- Anda bisa pastikan gambar ini ada, atau ganti dengan link valid -->
                                        <img src="{{ asset('assets/images/faces/2.jpg') }}">
                                    </div>
                                </div>
                            </div>
...
<!-- Menggunakan jQuery versi CDN terbaru & stabil -->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

<script>
    document.addEventListener('DOMContentLoaded', function () {

        // FUNGSI UNTUK KONTAK US (Didefinisikan agar tidak "is not defined")
        function updateContactUsNotifications() {
            // Jika suatu saat API untuk contact us sudah siap, logic-nya dimasukkan ke sini.
            // Saat ini kita biarkan sebagai placeholder pelindung.
            return true;
        }

        // FUNGSI UNTUK STOCK ALERT
        function updateStockAlerts() {
            // Jika route untuk API stock tidak valid/error 500, ini bisa menyebabkan block.
            // Oleh karena itu, bungkus dalam block try-catch.
            try {
                fetch("{{ route('check-stock-alerts') }}")
                    .then(response => {
                    ...
                    .then(data => {
                        // PERBAIKAN: Selalu cek apakah elemen tersebut BENAR-BENAR ADA sebelum diubah textContent-nya.
                        const stockBadge = document.getElementById('stock-alert-badge');
                        const lowStockAlert = document.getElementById('low-stock-alert');
                        const outOfStockAlert = document.getElementById('out-of-stock-alert');
                        const stockUpdateTime = document.getElementById('stock-update-time');
                    ...
                    .catch(error => {
                        // Hanya di-console, tidak mematikan script lain
                        console.warn('Stock Alerts fetching skipped/error:', error);
                    });
            } catch (err) {
                console.warn(err);
            }
        ...
        // Periodic updates (dihapus sementara jika API tidak tersedia untuk menghemat request)
        // setInterval(updateStockAlerts, 30000);
        // setInterval(updateContactUsNotifications, 30000);
    });
</script>
