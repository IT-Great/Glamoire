...
<style>
    ...
    .action-icon {
        color: var(--nav-text);
        font-size: 1.15rem; /* Ukuran pas agar minimalis walau pakai fas */
        position: relative;
        text-decoration: none;
        transition: color var(--transition-speed);
        background: transparent;
...
<nav class="premium-navbar md:px-20 lg:px-24 xl:px-24 2xl:px-48">
    <div class="container-fluid d-flex align-items-center justify-content-between h-100">
        ...
        <ul class="nav-links-container desktop-nav-links">
            ...
            <li class="nav-item-dropdown">
                <button class="nav-link-premium">
                    Brand <i class="fas fa-chevron-down ms-1" style="font-size:0.6rem; opacity: 0.8;"></i>
                </button>
                ...
                <li>
                    ...
                    <div class="mobile-cat-body">
                        ...
                        @else
                            ...
                            @endforeach
                            <a href="{{ route('shop.category', ['category' => $category->name]) }}" class="mobile-subcat-link fw-bold" style="color: var(--nav-bg);">
                                View All Category <i class="fas fa-arrow-right ms-1" style="font-size: 0.8rem;"></i>
                            </a>
                        @endif
                    </div>
                </li>
