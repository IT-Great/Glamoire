<div class="py-2 md:px-20 lg:px-24 xl:px-48 2xl:px-96 position-sticky" style="top:-0.1rem;background-color: #183018;z-index: 9;">
      ...
      <div class="flex w-full align-items-center">
        ...
        <div class="col-lg-4 d-none d-lg-block">
          ...
          <div class="list-inline-item dropdown">
            ...
            <ul class="dropdown-menu bg-transparent border-none">
              <div class="container mt-2 p-0 bg-white custom-shadow rounded-md overflow-y-auto custom-scroll border-white border-8" style="min-height: 50vh;max-height:50vh; min-width: 40vw;">
                <div class="text-center">
                    <h2 class="section-title px-5 text-[10px] md:text-[14px] lg:text-[16px] xl:text-[18px] mt-4"><span class="px-2">Semua Brand</span></h2>
                </div>
        ...
        <div class="col-lg-6 col-md-9 d-none d-md-block">
          <form method="GET" action="{{route('search.product')}}" id="search-product-form-desktop">
            <div class="input-group">
              <input class="form-control rounded-start text-[9px] md:text-[10px] lg:text-[11px] xl:text-[12px]" 
                type="text" 
                id="search-product-desktop" 
                name="product_search" 
  ...
  <div class="container-fluid mt-2 mt-md-0 d-md-none p-0">
