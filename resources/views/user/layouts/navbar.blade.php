<div class="py-2 md:px-20 lg:px-24 xl:px-24 2xl:px-96 position-sticky"
            ...
            <div class="col-lg-4 d-none d-lg-block">
                <div class="list-inline-item dropdown">
                    <a class="p-1 text-white text-decoration-none text-[9px] md:text-[10px] lg:text-[11px] xl:text-[12px] hover:bg-neutral-700"
                        href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Belanja</a>
                    <ul class="dropdown-menu bg-transparent border-none">
                        <div class="flex container mt-2 custom-shadow p-0 bg-white"
                            ...
                            <div class="col-2 w-fit px-0 min-h-[77vh] overflow-y-auto custom-scroll max-h-[75vh]">
                                <nav class="tabbable border-none">
                                    <div class="nav grid nav-tabs border-none mb-2 mb-md-4 w-full" id="nav-tab"
                                        role="tablist">
                ...
                <div class="list-inline-item dropdown">
                    ...
                    <ul class="dropdown-menu bg-transparent border-none">
                        <div class="flex container mt-2 p-0 bg-white custom-shadow rounded-md overflow-y-auto custom-scroll border-white border-8"
                            style="min-height: fit;max-height:fit; min-width: 40vw;">
            ...
            <div class="col-lg-6 col-md-9 d-none d-md-block">
                <form method="GET" action="{{ route('search.product') }}" id="search-product-form">
                    <div class="input-group">
                        <input
                            class="form-control rounded-start text-[9px] md:text-[10px] lg:text-[11px] xl:text-[12px]"
...
<div class="d-lg-none fixed-bottom mt-8">
    <div id="categories" class="container d-none w-full h-[83vh] bg-white px-0">
        ...
        <div class="flex">
            <div class="col-3 px-0 min-h-[77vh] overflow-y-auto custom-scroll max-h-[75vh]">
                <nav class="tabbable border-none">
    ...
    <div id="brands" class="container d-none w-full h-[83vh] bg-white px-0">
        ...
        <div class="container px-3 min-h-[77vh] p-0 overflow-y-auto max-h-[75vh]">
            <div class="flex container mt-2 p-0 bg-white custom-shadow rounded-md overflow-y-auto custom-scroll border-white border-8"
                style="min-height: 50vh;max-height:50vh; min-width: 40vw;">
                <div class="grid-container-brands h-fit p-3">
                    @foreach ($brands as $brand)
                        <a href="/{{ $brand->name }}_brand"
                            class="py-2 text-sm rounded-sm border border-primary hover:border-dark hover:bg-[#183018] hover:text-white text-decoration-none text-center">
        ...
        <div class="d-flex text-center text-white justify-content-between">
            ...
            <div>
                <a href="/newsletter"
                    ...
                    <p class="p-0 text-white text-[9px] md:text-[10px] lg:text-[11px] xl:text-[12px]" role="button">
                        Newsletter</p>
                </a>
            </div>
