    ...
    <div class="d-flex w-full align-items-center">
      ...
      <div class="col-lg-4 d-none d-lg-block">
        ...
        <div class="list-inline-item dropdown">
          ...
          <ul class="dropdown-menu bg-transparent border-none">
            <div class="flex container mt-2 p-0 bg-white custom-shadow rounded-md overflow-y-auto custom-scroll border-white border-8" style="min-height: fit;max-height:fit; min-width: 40vw;">
...
<div class="d-lg-none fixed-bottom mt-8">
    ...
    <div id="brands" class="container d-none w-full h-[83vh] bg-white px-0">
      ...
      <div class="container px-3 min-h-[77vh] p-0 overflow-y-auto max-h-[75vh]">
        <div class="flex container mt-2 p-0 bg-white custom-shadow rounded-md overflow-y-auto custom-scroll border-white border-8" style="min-height: 50vh;max-height:50vh; min-width: 40vw;">
          <div class="grid-container-brands h-fit p-3">
            @foreach ($brands as $brand)
              <a href="/{{ $brand->name }}_brand" class="py-2 text-sm rounded-sm border border-primary hover:border-dark hover:bg-[#183018] hover:text-white text-decoration-none text-center">
                {{ $brand->name }}
