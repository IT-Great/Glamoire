<footer class="mb-12 mb-lg-0">
  <div class="container-fluid text-dark">
    <div class="row" style="background-color: #183018">
      <div class="col">
        <div class="py-2 flex items-center justify-between w-full md:px-20 lg:px-24 xl:px-48 2xl:px-96">
    ...
    <div class="row md:px-20 lg:px-24 xl:px-48 2xl:px-96 pt-2 md:pt-5 lg:pt-5 xl:pt-5">
      ...
      <div class="col-lg-2 text-start">
        <ul id="footer-navigasi" class="decoration-none flex md:grid justify-content-between gap-1">
          <li>
            <a class="text-dark text-[7px] md:text-[10px] lg:text-[12px] xl:text-[14px]" href="/about">Tentang</a>
          </li>
          <li>
            <a class="text-dark text-[7px] md:text-[10px] lg:text-[12px] xl:text-[14px]" href="/contact">Hubungi</a>
          </li>
          <li>
            <a class="text-dark text-[7px] md:text-[10px] lg:text-[12px] xl:text-[14px]" href="/privacy">Kebijakan</a>
          </li>
          <li>
            <a class="text-dark text-[7px] md:text-[10px] lg:text-[12px] xl:text-[14px]" href="/terms">S&K</a>
          </li>
          <li>
            <a class="text-dark text-[7px] md:text-[10px] lg:text-[12px] xl:text-[14px]" href="/help">Bantuan</a>
          </li>
          <li>
            <a class="text-dark text-[7px] md:text-[10px] lg:text-[12px] xl:text-[14px]" href="/partner">Mitra</a>
          </li>
        </ul>
      </div>
    </div>
  
    <div class="row md:px-20 lg:px-24 xl:px-48 2xl:px-96 pt-2">
      <div class="col">
