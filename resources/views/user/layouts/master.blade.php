                    ...
                    <div class="grid px-0 px-md-4">
                        ...
                        <p
                            ...
                            <a href="#" class="ml-1 text-[10px] md:text-[8px] lg:text-[10px] xl:text-[12px]"
                                data-bs-toggle="modal" data-bs-target="#register" data-bs-dismiss="modal">Daftar
                                Sekarang</a>
                        </p>
                    </div>
                </div>
                            ...
                            <div class="grid">
                                <p
                                    ...
                                    <a href="#"
                                        ...
                                        data-bs-toggle="modal" data-bs-target="#login" data-bs-dismiss="modal">Masuk
                                        Sekarang</a>
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="text-center text-sm">
                                <p class="text-white py-4">Sudah Ingat Akunmu?
                                    <a href="#" class="text-white ml-1" data-bs-toggle="modal"
                                        data-bs-target="#login" data-bs-dismiss="modal">Masuk</a>
                                </p>
                            </div>
                        </div>
                    </form>
