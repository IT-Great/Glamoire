...
@section('content')
    ...
    <style>
        /* ==========================================
           WORLD CLASS BRAND SHOWCASE STYLING
           ========================================== */
        :root {
        ...
        /* --- Brand Vouchers Slider --- */
        .brand-voucher-wrapper {
            margin-bottom: 3rem;
        }
    ...
    <div class="md:px-20 lg:px-24 xl:px-24 2xl:px-48 pt-4 pb-5">
        ...
        <div class="container-fluid">
            <div class="premium-breadcrumb">
                ...
                <span>/</span>
                <span class="active-page">{{ $brandName }}</span>
            </div>
        </div>
            ...
            @foreach ($brands as $brand)
                <div class="brand-hero">
                    <div class="brand-logo-wrapper">
                        <img src="{{ $brand->brand_logo ? Storage::url($brand->brand_logo) : asset('images/brand-empty-logo.png') }}"
                            alt="{{ $brand->name }}">
                    </div>
                    <div class="brand-info">
                        <h1>{{ $brand->name }}</h1>
                        <p>{{ $brand->description ?? 'Jelajahi koleksi eksklusif dari ' . $brand->name . ', dirancang khusus untuk kecantikan alami Anda. Dapatkan produk original dengan penawaran terbaik hanya di Glamoire.' }}
                        </p>
                    </div>
                </div>
            @endforeach
        ...
        <div class="container-fluid px-0">
            <nav class="nav premium-tabs px-3" id="nav-tab" role="tablist">
                ...
                <button class="nav-link" id="tab-allproduct" data-bs-toggle="tab" data-bs-target="#allproduct" type="button"
                    role="tab">Katalog Produk</button>
            </nav>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active px-3" id="beranda" role="tabpanel">
                                ...
                                <div class="swiper-wrapper">
                                    @foreach ($brandVouchers as $voucher)
                                        <div class="swiper-slide">
                                            <div class="voucher-card" data-bs-toggle="modal"
                                                data-bs-target="#voucher-{{ $voucher->id }}">
                    ...
                    <div class="mt-5">
                        ...
                        @else
                            <p class="text-muted">Belum ada produk terbaru dari brand ini.</p>
                        @endif
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        @else
                            <p class="text-muted">Belum ada data penjualan untuk brand ini.</p>
                        @endif
                    </div>

                </div>

                <div class="tab-pane fade" id="allproduct" role="tabpanel">
                        ...
                        <form action="{{ route('detail.brand.user', ['nameBrand' => $brandName]) }}" method="GET"
                            ...
                            <div class="filter-group-container px-3">
                                <div class="filter-left">
                                    ...
                                    <div class="dropdown">
                                        <button class="filter-pill" type="button" data-bs-toggle="dropdown"
                                            ...
                                            <div class="price-range-wrapper">
                                                <div class="price-inputs">
                                                    <div class="price-input-box">
                                                        <span>Rp</span>
                                                        <input type="number" name="min_price" id="min-price-desk"
                                                ...
                                                <div class="filter-actions">
                                                    <button type="button" class="btn-apply-filter"
                                                        onclick="autoSubmitFilter()">Terapkan</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="dropdown-menu filter-dropdown-menu">
                                            ...
                                            <div class="custom-check-group">
                                                <label class="modern-checkbox">
                                                    <input type="radio" name="rating" value="all" {{ request('rating') == 'all' || !request('rating') ? 'checked' : '' }}
                                                        onchange="autoSubmitFilter()"> Semua Rating
                                                </label>
                                                <label class="modern-checkbox">
                                                    <input type="radio" name="rating" value="5" {{ request('rating') == '5' ? 'checked' : '' }} onchange="autoSubmitFilter()"> <span
                                                        class="text-warning"><i class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star"></i></span>
                                                </label>
                                                <label class="modern-checkbox">
                                                    <input type="radio" name="rating" value="4" {{ request('rating') == '4' ? 'checked' : '' }} onchange="autoSubmitFilter()"> <span
                                                        class="text-warning"><i class="fas fa-star"></i><i
                                                            class="fas fa-star"></i><i class="fas fa-star"></i><i
                                ...
                                <div class="filter-right">
                                    ...
                                    <div class="position-relative">
                                        <select class="sort-select" onchange="setSort(this.value)">
                                            <option value="" {{ request('sort') == null ? 'selected' : '' }}>Rekomendasi
                                            </option>
                    ...
                    <div id="productList" style="display: none;" class="px-3">
                                ...
                                @foreach ($brands->first()->products as $product)
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <div class="premium-product-card"
                                            ...
                                            <div class="card-info">
                                                <div class="brand-name">{{ $product->brand ? $product->brand->name : 'Glamoire' }}
                                                </div>
                                                <a href="/{{ $product->product_code }}_product"
                                                    class="product-name">{{ $product->product_name }}</a>
                        ...
                        @else
                            <div class="empty-state">
                                <img src="{{ asset('images/product-empty.png') }}" alt="Produk Kosong">
                                <h3>Tidak Ada Produk</h3>
                                <p>Brand ini belum memiliki produk untuk ditampilkan.</p>
                            </div>
                        @endif
                    </div>
            ...
            <form action="{{ route('detail.brand.user', ['nameBrand' => $brandName]) }}" method="GET"
                ...
                <div class="mb-4">
                    ...
                    <select name="sort" class="form-select rounded-pill">
                        ...
                        <option value="low_price" {{ request('sort') == 'low_price' ? 'selected' : '' }}>Harga Terendah
                        </option>
                    </select>
                </div>
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            ...
                            <input type="number" class="form-control" name="min_price"
                                value="{{ request('min_price') ?? 0 }}" placeholder="Min">
                        </div>
                        <div class="col-6">
                            <label class="form-label text-muted fs-7">Tertinggi</label>
                            <input type="number" class="form-control" name="max_price"
                                value="{{ request('max_price') ?? 1000000 }}" placeholder="Max">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="p-4">
                            ...
                            <ul class="text-muted fs-7 ps-3 m-0" style="line-height: 1.6;">
                                ...
                                <li>Min. transaksi Rp<strong
                                        class="text-dark">{{ number_format($voucher->min_transaction, 0, ',', '.') }}</strong>.
                                </li>
                                <li>Berlaku: <span
                                        class="text-dark">{{ \Carbon\Carbon::parse($voucher->start_date)->translatedFormat('d M Y') }}
                                        - {{ \Carbon\Carbon::parse($voucher->end_date)->translatedFormat('d M Y') }}</span>.
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            // Swipers for Brand Beranda
            new Swiper(".mySwiperVoucher", {
                slidesPerView: 1.2, spaceBetween: 16,
                breakpoints: { 768: { slidesPerView: 2.2 }, 992: { slidesPerView: 3 } }
            });

            new Swiper(".mySwiperNewest", {
                slidesPerView: 2, spaceBetween: 15,
                navigation: { nextEl: ".mySwiperNewest .swiper-button-next", prevEl: ".mySwiperNewest .swiper-button-prev" },
                breakpoints: { 768: { slidesPerView: 3 }, 992: { slidesPerView: 4 } }
            });

            new Swiper(".mySwiperTop", {
                slidesPerView: 2, spaceBetween: 15,
                navigation: { nextEl: ".mySwiperTop .swiper-button-next", prevEl: ".mySwiperTop .swiper-button-prev" },
                breakpoints: { 768: { slidesPerView: 3 }, 992: { slidesPerView: 4 } }
            });

            // Skeleton & Mobile Filter Trigger Logic
            ...
            tabs.forEach(tab => {
                tab.addEventListener('shown.bs.tab', function (event) {
                    if (event.target.id === 'tab-allproduct') {
                        if (window.innerWidth < 992 && mobileTrigger) mobileTrigger.style.display = 'flex';
                    } else {
                        if (mobileTrigger) mobileTrigger.style.display = 'none';
                    }
                });
            ...
            // Show specific tab if requested by filter
            const urlParams = new URLSearchParams(window.location.search);
            if (urlParams.has('sort') || urlParams.has('min_price') || urlParams.has('rating')) {
                document.getElementById('tab-allproduct').click();
            }
