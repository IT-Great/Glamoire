...
@section('content')
    <style>
        ...
        /* ==========================================
           PRODUCT CARD STYLING (For "You May Also Like")
           ========================================== */
        ...
        .btn-add:hover { background: #2A4D2A; box-shadow: 0 4px 15px rgba(24, 48, 24, 0.3); color: #FFF;}
        ...
        .premium-product-card:hover .product-name-rec { color: #D4AF37; }
    ...
    <div class="md:px-20 lg:px-24 xl:px-24 2xl:px-48 pt-4">
        ...
        <div class="container-fluid">
            ...
            @endif
        </div> @if(isset($recommendedProducts) && count($recommendedProducts) > 0)
        <div class="container-fluid mt-5 pt-4 border-top" style="margin-bottom: 7rem;">
            <h3 class="mb-4 fw-bold" style="font-family: 'The Seasons', serif; color: var(--glamoire-dark); font-size: 2rem;">You May Also Like</h3>
            <div class="swiper recommended-slider pb-5">
                <div class="swiper-wrapper">
                    @foreach($recommendedProducts as $product)
                        @php
                            ...
                            $inCart = in_array($product->id, $cartItemsArray ?? []);
                        @endphp
                        <div class="swiper-slide h-auto">
                            <div class="premium-product-card">
                                <div class="card-img-box {{ $product->stock_quantity == 0 ? 'dark-overlay' : '' }}" onclick="window.location.href = '/{{ $product->product_code }}_product'">
                                    ...
                                    <div class="btn-wishlist {{ $inWishlist ? 'active' : '' }}" onclick="event.stopPropagation(); {{ $inWishlist ? 'removeFromWishlist(' . $product->id . ')' : 'addToWishlist(' . $product->id . ')' }}">
                                ...
                                <div class="card-info" onclick="window.location.href = '/{{ $product->product_code }}_product'">
                                    <div class="brand-name">{{ $product->brand ? $product->brand->name : 'Glamoire' }}</div>
                                    <a href="/{{ $product->product_code }}_product" class="product-name-rec">{{ $product->product_name }}</a>
                                    <div class="rating-box"><i class="fas fa-star"></i> <span>{{ $product->rating ?? '5.0' }}</span></div>
                                    <div class="price-box">
    ...
    <script>
        ...
        function calculateTotal() {
            ...
            $('.item-checkbox:checked').each(function () {
                let idAttr = $(this).attr('id').split('_')[1];
                let quantity = parseInt($('#product-quantity-' + idAttr).val()) || 1;
                let price = parseFloat($(this).data('price')) || 0;
        ...
        $(document).ready(function () {
            ...
            var swiperRecommended = new Swiper(".recommended-slider", {
                slidesPerView: 1.5,
                spaceBetween: 15,
                navigation: {
                ...
                breakpoints: {
                    ...
                    992: { slidesPerView: 4.5, spaceBetween: 24 },
                    1200: { slidesPerView: 5.5, spaceBetween: 24 }
                },
            });
