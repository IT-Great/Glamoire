        ...
        <form action="{{ route('search.product') }}" method="GET" id="form-filter-product">
          ...
          <div class="filter-group-container">
            <div class="filter-left">
              ...
              <div class="dropdown">
                <button class="filter-pill {{ $data['rating'] && $data['rating'] != 'all' ? 'active-filter' : '' }}"
                  type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                  Rating <i class="fas fa-star text-warning mx-1" style="font-size: 0.75rem;"></i> <i class="fas fa-chevron-down"></i>
                </button>
                <div class="dropdown-menu filter-dropdown-menu">
                  <div class="filter-dropdown-title">Pilih Rating Minimum</div>
                  <div class="custom-check-group">
                    <label class="modern-checkbox">
                      <input type="radio" name="rating" value="all" {{ $data['rating'] === null || $data['rating'] === 'all' ? 'checked' : '' }} onchange="autoSubmitFilter()"> Semua Rating
                    </label>
                    <label class="modern-checkbox">
                      <input type="radio" name="rating" value="4" {{ $data['rating'] == '4' ? 'checked' : '' }} onchange="autoSubmitFilter()"> <i class="fas fa-star text-warning mx-1"></i> 4 ke Atas
                    </label>
                    <label class="modern-checkbox">
                      <input type="radio" name="rating" value="3" {{ $data['rating'] == '3' ? 'checked' : '' }} onchange="autoSubmitFilter()"> <i class="fas fa-star text-warning mx-1"></i> 3 ke Atas
                    </label>
                  </div>
                </div>
              </div>
  ...
  <div class="offcanvas offcanvas-bottom rounded-top-4" tabindex="-1" id="mobileFilter" style="height: 85vh;">
    ...
    <div class="offcanvas-body pb-5 mb-5 custom-scroll">
      <form action="{{ route('search.product') }}" method="GET" id="form-filter-product-mobile">
        ...
        <div class="mb-4">
          <h6 class="fw-bold mb-3">Rating Minimum</h6>
          <div class="custom-check-group">
            <label class="modern-checkbox">
              <input type="radio" name="rating" value="all" {{ $data['rating'] === null || $data['rating'] === 'all' ? 'checked' : '' }}> Semua Rating
            </label>
            <label class="modern-checkbox">
              <input type="radio" name="rating" value="4" {{ $data['rating'] == '4' ? 'checked' : '' }}> <i class="fas fa-star text-warning mx-1"></i> 4 ke Atas
            </label>
            <label class="modern-checkbox">
              <input type="radio" name="rating" value="3" {{ $data['rating'] == '3' ? 'checked' : '' }}> <i class="fas fa-star text-warning mx-1"></i> 3 ke Atas
            </label>
          </div>
        </div>
