...
<div class="container-fluid md:px-20 lg:px-24 xl:px-24 2xl:px-48 h-[40vh] md:h-[50vh] lg:h-[80vh] xl:h-[100vh] d-flex justify-content-center align-items-center" style="background-image: url('images/bg.png');background-size: cover; background-position: center;">
  ...
  <div class="p-1 p-md-3 p-lg-4 p-xl-4">
    ...
    <div class="grid gap-1 gap-md-3 p-0 col-8 col-md-6">
      <p class="text-[#CE8B50] text-[14px] md:text-[20px] lg:text-[40px] xl:text-[54px] aclonica-regular" style="line-height: 1.1;">Temukan Kecantikan Sejati Anda dengan Glamoire</p>
      <div>
...
<div class="container-fluid my-2 my-md-4 grid gap-2 gap-md-4 md:px-20 lg:px-24 xl:px-24 2xl:px-48">
  <div class="grid md:flex">
    ...
    <div class="col-12 col-md-6 px-md-12 flex justify-content-center align-items-center px-0 px-md-2">
      <div class="grid gap-1 gap-md-2">
        <h1 class="font-semibold text-[12px] md:text-[20px] lg:text-[24px] xl:text-[28px]">Glamoire</h1>
        <p class="text-start md:text-justify text-black text-[10px] md:text-[10px] lg:text-[16px] xl:text-[18px]">E-commerce yang berkomitmen untuk menyediakan produk kosmetik berkualitas tinggi yang berbahan dasar tanaman. 
  ...
  <div class="grid md:flex flex-col-reverse md:flex-row">
    ...
    <div class="col-12 col-md-6 px-md-12 flex justify-content-center align-items-center px-0 px-md-2">
      <div class="grid gap-1 gap-md-2">
        <h1 class="text-end font-semibold text-[12px] md:text-[20px] lg:text-[24px] xl:text-[28px]">Our Vision</h1>
        <p class="text-end text-black text-[10px] md:text-[10px] lg:text-[16px] xl:text-[18px]">
          E-commerce yang berkomitmen untuk menyediakan produk kosmetik berkualitas tinggi yang berbahan dasar tanaman.
          Kami percaya bahwa kecantikan tidak harus mengorbankan kesejahteraan lingkungan.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="grid md:flex">
    ...
    <div class="col-12 col-md-6 px-md-12 flex justify-content-center align-items-center px-0 px-md-2">
      <div class="grid gap-1 gap-md-2">
        <h1 class="text-start font-semibold text-[12px] md:text-[20px] lg:text-[24px] xl:text-[28px]">Glamoire</h1>
        <p class="text-start md:text-justify text-black text-[10px] md:text-[10px] lg:text-[16px] xl:text-[18px]">E-commerce yang berkomitmen untuk menyediakan produk kosmetik berkualitas tinggi yang berbahan dasar tanaman. 
        Kami percaya bahwa kecantikan tidak harus mengorbankan kesejahteraan lingkungan.</p>
      </div>
    </div>
