...
<script src="https://staging.doku.com/doku-js"></script>
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var checkoutButton = document.getElementById('tes');

        // Check if the button exists to avoid errors
        if (checkoutButton) {
            checkoutButton.addEventListener('click', function () {
                // Replace the URL below with the dynamic payment URL from your server response
                const paymentUrl = 'https://jokul.doku.com/checkout/link/SK-rv8ayMOF1TTSovsB5by';
