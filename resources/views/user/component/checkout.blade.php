...
@section('content')
        ...
        <div class="container-fluid px-0 px-md-3">
            <div class="shadow-sm border border-black rounded-sm py-2 py-md-3 my-2 my-md-3 px-0 px-md-3">
                <div class="d-flex gap-1 px-3 px-md-0">
                    ...
                    <p class="text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px]"> > </p>
                    <a href="#"
                        class="text-black text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px]">Pembayaran</a>
                </div>
            </div>
        </div>
        ...
        <div class="row gap-2 gap-md-0 m-0 p-0 mb-2">
            <div class="col-lg-8 grid gap-2 px-0 px-md-3">
                @if (count($data['address']) !== 0)
                    @foreach ($data['address'] as $checkout_address)
                        @if ($checkout_address->is_use)
                            <div
                                class="col-12 md:shadow-md md:rounded p-md-3 py-2 py-md-0 border-bottom border-top md:border-none">
                                <h1
                                    class="font-semibold text-black text-[12px] md:text-[12px] lg:text-[12px] xl:text-[13px] mb-2">
                                    Alamat Pengiriman</h1>
                                <div class="grid gap-1 gap-md-2 mb-md-2">
                                    <div class="d-flex gap-1 gap-md-2 align-items-center">
                                        <i
                                            class="fas fa-location-arrow text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px]"></i>
                                        <p class="text-black text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px]">
                                            {{ $checkout_address->label }}</p>
                                        <p
                                            class="font-bold text-black text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px]">
                                            .</p>
                                        <p class="text-black text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px]">
                                    ...
                                    <div class="d-flex">
                                        <button type="button"
                                            class="btn btn-dark rounded-sm text-white text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px] bg-[#183018] hover:bg-neutral-900"
                                            data-bs-toggle="modal" data-bs-target="#change_address" id="change-address">
                                            Ubah Alamat
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content overflow-y-auto" style="max-height:90vh;">
                                <div class="modal-header" style="background-color: #183018">
                                    <h1 class="modal-title text-white text-[12px] md:text-[12px] lg:text-[12px] xl:text-[13px]"
                                ...
                                <div class="modal-body overflow-y-auto" style="max-height:100vh;">
                                    <form method="POST" action="{{ route('add.shipping.address') }}"
                                        ...
                                        <div class="grid gap-1 gap-md-2">
                                            ...
                                            <div class="col-12 p-0">
                                                <button
                                                    class="btn btn-primary w-full rounded-sm text-white text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px] bg-[#183018] hover:bg-neutral-900"
                ...
                <form class="grid gap-2">
                    @csrf
                    <div
                        class="col-12 md:shadow-md md:rounded border-bottom border-top md:border-none p-md-3 px-3 px-md-0 py-2 py-md-0">
                        <h1 class="font-semibold text-black text-[12px] md:text-[12px] lg:text-[12px] xl:text-[13px] mb-2">
                        ...
                        <div class="grid gap-1 gap-md-2 mb-md-2">
                            <div class="flex gap-1 align-items-center">
                                ...
                                <p class="text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px] text-[#183018]">Dikirim
                            ...
                            <div class="flex gap-1 align-items-center">
                                ...
                                @foreach ($data['address'] as $checkout_address)
                                    @if ($checkout_address->is_use)
                                        <p class="text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px] text-[#183018]">
                            ...
                            <div class="flex gap-1 align-items-center">
                                ...
                                <p class="text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px] text-[#183018]">Berat
                                    Produk :
                                    @if ($data['weight'] < 1000)
                                        {{ $data['weight'] }}gr
                                    @else
                            ...
                            <div class="flex gap-1 align-items-center">
                                ...
                                <p class="text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px] text-[#183018]">Tarif
                                    Pengiriman :</p>
                                <p class="text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px] text-[#183018]"
                                    id="shipping_price"></p>
                            </div>
                            <div id="shipping-fee" class="shipping">
                                <!-- SHIPPING -->
                                <select class="form-select text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px]"
                                    aria-label="chooseShippingFee" name="shipping_fee" id="choose_shipping_fee">
                                    @foreach ($data['shippingFee'] as $sp)
                                        <option value="{{ $sp['id'] }}">{{ $sp['description'] }} -
                                            Rp{{ number_format($sp['value'], 0, ',', '.') }} (estimasi {{ $sp['etd'] }}
                                            hari)</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    @foreach ($data['cartItems'] as $cart => $product)
                        <div
                            class="col-12 p-0 md:shadow-md md:border border-bottom border-top md:rounded p-md-3 px-3 px-md-0 py-2 py-md-0">
                            <div class="grid">
                                <h1
                                    class="text-black font-semibold text-[12px] md:text-[12px] lg:text-[12px] xl:text-[13px] mb-1 mb-md-2">
                                    Produk - {{ $cart + 1 }}</h1>
                            </div>
                                ...
                                <div class="flex">
                                    ...
                                    <div class="col p-0">
                                        <div class="flex col-12 gap-1 gap-md-2 pl-1 pl-md-3">
                                            <p
                                                class="font-semibold text-black text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px]">
                                                {{ $product->product->brand->name }}</p>
                                        </div>
                                        <div class="grid lg:flex">
                                            <div class="col-lg-9 pl-1 pl-md-3">
                                                <p
                                                    class="text-black text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px]">
                                                    ...
                                                    <div class="grid gap-1 font-semibold">
                                                        <div>
                                                            <del class="d-flex gap-1">
                                                                <p
                                                                    class="text-black text-[10px] md:text-[10px] lg:text-[11px] xl:text-[12px] text-muted">
                                                                    {{ $product->quantity }}</p>
                                                                <p
                                                                    class="text-black text-[10px] md:text-[10px] lg:text-[11px] xl:text-[12px] text-muted">
                                                                    X</p>
                            ...
                            @else
                                <div class="flex">
                                    <div class="w-[70px] h-[70px] w-md-[110px] h-md-[110px]">
                                        <img src="{{ Storage::url($product->productVariant->variant_image) }}"
                                            alt="gambar produk" class="rounded-sm border">
                                    </div>
                                    <div class="col p-0">
                                        <div class="flex col-12 gap-1 gap-md-2 pl-1 pl-md-3">
                                            <p
                                        ...
                                        <div class="grid lg:flex">
                                            <div class="col-lg-9 pl-1 pl-md-3">
                                                <p
                                                    ...
                                                    {{ $product->product->product_name }}</p>
                                                <span
                                                    class="w-fit bg-[#183018] text-white py-1 px-2 rounded-sm text-[9px] md:text-[9px] lg:text-[9px] xl:text-[11px] text-center text-decoration-non">
            ...
            <div class="col-lg-4 pl-0 pl-md-3 pr-0 pr-md-3 pl-lg-0 mt-0 mt-md-2 mt-lg-0">
                <div class="position-sticky" style="top: 4.5rem">
                    <div class="p-3 bg-light rounded shadow-sm border border-[#183018] grid gap-2 gap-md-2">
                        <h1 class="font-semibold text-black text-[14px] md:text-[12px] lg:text-[12px] xl:text-[13px]">
                            Rincian Biaya</h1>

                        <div class="grid gap-1">
                            <div class="d-flex">
                                <p class="text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px]">Total Harga
                                    ({{ $data['totalProduct'] }} Barang)</p>
                                <p class="text-[10px] md:text-[10px] lg:text-[12px] xl:text-[13px] ml-auto">
                        ...
                        <div class="d-flex py-2 border-bottom border-top align-items-center">
                            <p class="text-black text-[12px] md:text-[10px] lg:text-[12px] xl:text-[13px]">Total Belanja
                            </p>
                            <p class="text-black font-semibold text-[12px] md:text-[12px] lg:text-[16px] xl:text-[18px] ml-auto"
                                id="total-shopping">Rp{{ number_format($data['totalPrice'], 0, ',', '.') }}</p>
                        </div>
                        <div>
                            <div class="relative flex gap-1 items-center input-code">
                                <div class="cancel-code-voucher text-[#183018] absolute" role="status"
                                    ...
                                    <button type="button" class="btn rounded-sm w-fit font-semibold text-sm text-danger"
                                        onclick="removeCode()" id="cancelCode">X</button>
                                </div>
                                <input type="text"
                                    class="form-control pl-5 w-full rounded-sm text-[12px] md:text-[10px] lg:text-[12px] xl:text-[13px]"
                                ...
                                <button type="button" id="button-code-voucher"
                                    class="btn border rounded-sm w-fit text-white text-[12px] md:text-[10px] lg:text-[12px] xl:text-[13px] hover-shadow-md"
                        ...
                        <button type="button"
                            class="d-flex align-items-center btn btn-dark rounded-sm text-black text-[6px] md:text-[10px] lg:text-[12px] xl:text-[13px]"
                            data-bs-toggle="modal" data-bs-target="#promo" style="background-color: #FFFFFF"
                            id="show-voucher">
                            <i
                                class="fas fa-solid fa-tag mr-2 text-[12px] md:text-[10px] lg:text-[12px] xl:text-[13px]"></i>
                            <p class="text-[12px] md:text-[10px] lg:text-[12px] xl:text-[13px]" id="choose-voucher">Pilih
                                Voucher</p>
                            <i
                                class="fas fa-solid fa-arrow-right ml-auto text-[12px] md:text-[10px] lg:text-[12px] xl:text-[13px]"></i>
                        </button>
    ...
    <script>
        ...
        productItems.forEach((product, index) => {
            formattedData[index] = {
                ...
                product_variant_id: product.product_variant_id ||
                    null // Gunakan null jika product_variant_id tidak ada
            };
        });
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        $("#choose-voucher").text("Kode promo berhasil diterapkan.").addClass(
                            'text-success').show();
        ...
        function updateTotals(response) {
            ...
            if (response.ongkir) {
                shippingDiscountAmount = parseInt(response.ongkirCalculate.replace(/\./g, ''),
                    10); // Get shipping discount from response
    ...
    //           `);
        ...
        $(document).ready(function() {
            ...
            $('body').append(`
        <div class="modal fade" id="prismalinkPaymentModal" tabindex="-1" aria-labelledby="prismalinkPaymentModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #183018">
                        <h5 class="modal-title text-white text-[12px] md:text-[12px] lg:text-[12px] xl:text-[13px]" id="prismalinkPaymentModalLabel">Pembayaran</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body" id="prismalinkPaymentContainer">
                        <div class="text-center" id="loadingPayment">
                            <div class="spinner-border text-primary" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
    ...
    `);
            ...
            $('#paynow').click(function(e) {
                ...
                // Show payment modal
                $('#prismalinkPaymentModal').modal('show');

                // Collect product data from the cart
                // This is an example - adjust according to your actual data structure
                const cartItems = collectCartItems(); // This is a function you need to implement
                const formattedData = JSON.stringify(cartItems);

                // Get other necessary data
                const shippingAddressId = $('#shipping_address_id').val();
                const ongkir = parseFloat($('#shipping_cost').val() || 0);
                const subTotal = parseFloat($('#subtotal').val() || 0);
                const totalItem = parseInt($('#total_item').val() || 0);
                const totalItemPrice = parseFloat($('#total_item_price').val() || 0);
                const discountAmount = parseFloat($('#discount_amount').val() || 0);
                const shippingDiscount = parseFloat($('#discount_ongkir').val() || 0);
                const selectedPromoCode = $('#voucher_promo').val();
                const selectedOngkirCode = $('#voucher_ongkir').val();

                // Make AJAX request to initiate payment
                $.ajax({
                    url: '/initiate-prismalink-payment',
                    method: 'POST',
                    data: {
                        total_amount: subTotal + ongkir - discountAmount - shippingDiscount,
                        products: formattedData,
                        subtotal: subTotal,
                        shipping_cost: ongkir,
                        shipping_address_id: shippingAddressId,
                    ...
                    success: function(response) {
                        if (response.success && response.payment_url) {
                            // Load Prismalink payment iframe
                            console.log({
                                paymentUrl: response.payment_url,
                                result: response.data,
                            });
                            $('#prismalinkPaymentContainer').html(`
                        <iframe 
                            src="${response.payment_url}"
                            frameborder="0"
                            width="100%"
            ...
            // Helper function to collect cart items (implement according to your data structure)
            function collectCartItems() {
                const items = [];
                // Example implementation - adjust based on your actual HTML structure
                $('.cart-item').each(function() {
                    const item = $(this);
                    items.push({
                        id: item.data('product-id'),
                        name: item.data('product-name'),
                        price: parseFloat(item.data('product-price')),
                        quantity: parseInt(item.data('quantity')),
                        variant_id: item.data('variant-id') || null
                    });
                });
                return items;
            }
            ...
            <div class="modal-content overflow-y-auto" style="max-height:90vh;">
                <div class="modal-header bg-[#183018]">
                    <div class="flex gap-3 justify-content-center align-items-center">
                        <h1 type="button" class="text-white font-semibold" data-bs-dismiss="modal" aria-label="Close">X
                        </h1>
                        <h1 class="modal-title text-white text-[12px] md:text-[10px] lg:text-[12px] xl:text-[13px]">Pilih
                            Alamat Pengiriman</h1>
                    </div>
                </div>
                                ...
                                text-[10px] md:text-[9px] lg:text-[11px] xl:text-[13px]">Utama</span>
                                    ...
                                    <div class="flex">
                                        <div class="col-10 p-0">
                                            <p class="text-[10px] md:text-[12px] lg:text-[12px] xl:text-[13px] text-black">
        ...
        <div class="modal-dialog">
            <div class="modal-content overflow-y-auto" style="max-height:90vh;">
                ...
                <div class="modal-body">
                    @foreach ($data['shippingFee'] as $sp)
                        <div class="col-12 mb-2 p-0 shipping-fee-detail" id="shipping-fee-{{ $sp['id'] }}"
                            ...
                            <div class="p-2 rounded-sm custom-shadow">
                                ...
                                <p class="text-[10px] md:text-[12px] lg:text-[12px] xl:text-[13px] text-black">
                                    {{ $sp['description'] }}</p>
                                <p class="text-[10px] md:text-[9px] lg:text-[11px] xl:text-[13px]">
                                    Rp{{ number_format($sp['value'], 0, ',', '.') }}</p>
                                <p class="text-[10px] md:text-[9px] lg:text-[11px] xl:text-[13px] ">Estimasi
                                    {{ $sp['etd'] }} hari</p>

                                <div class="d-flex gap-2 input-group-btn mt-2">
                                    <button type="button"
                                        class="bg-white hover:border-dark btn border w-full rounded-sm text-[#183018] text-[10px] md:text-[11px] lg:text-[13px] xl:text-[15px]"
                                        name="useShipping" data-id="{{ $sp['id'] }}">
                                        Gunakan
                                    </button>
                                </div>
                            </div>
            ...
            <div class="modal-content overflow-y-auto" style="max-height:90vh;">
                <div class="modal-header border-none bg-[#183018]">
                    <div class="flex gap-3 justify-content-center align-items-center">
                        ...
                        <h1 class="modal-title text-white text-[12px] md:text-[10px] lg:text-[12px] xl:text-[13px]">
                            Tambahkan Alamat Baru</h1>
                    </div>
            ...
            <div class="modal-content overflow-y-auto" style="max-height:90vh;">
                <div class="modal-header border-none bg-[#183018]">
                    <div class="flex gap-3 justify-content-center align-items-center">
                        ...
                        <h1 class="modal-title text-white text-[12px] md:text-[10px] lg:text-[12px] xl:text-[13px]">Gunakan
                            Voucher Promo</h1>
                    </div>
                </div>
                ...
                <div class="modal-body p-2 p-md-3 overflow-y-auto custom-scroll">
                    <div class="col-12 p-0 gap-1">
                        ...
                        @php
                            ...
                            $usableVouchers = $data['vouchers']->filter(function ($voucher) use (
                                $data,
                                $brandIds,
                                $productIds,
                                $voucherDisabled,
                                ...
                                if ($voucherDisabled == false) {
                                    if ($voucher->type == 'brand voucher') {
                                        return $productIds->intersect($data['brandVoucherIds'])->isNotEmpty() &&
                                            $data['totalPrice'] >= $voucher->min_transaction &&
                                            $data['totalItem'] <= $voucher->max_quantity_buyer;
                                    } elseif ($voucher->type == 'product voucher') {
                                        return $productIds->intersect($data['productVoucherIds'])->isNotEmpty() &&
                                            $data['totalPrice'] >= $voucher->min_transaction &&
                                            $data['totalItem'] <= $voucher->max_quantity_buyer;
                                    } else {
                        ...
                        @if (count($data['vouchers']) !== 0)
                            ...
                            @if ($usableVouchers->isNotEmpty())
                                <h5
                                    class="text-[#183018] text-[10px] md:text-[10px] lg:text-[11px] xl:text-[13px] mt-1 mt-md-0 font-semibold mb-1">
                                    Voucher yang bisa digunakan</h5>
                                @foreach ($usableVouchers as $voucher)
                                    <div class="col-12 p-1 p-md-2 promo-item {{ str_replace(' ', '-', $voucher->type) }}"
                                        data-code="{{ $voucher->promo_code }}"
                                        onclick="selectPromo(this, '{{ $voucher->promo_code }}', '{{ $voucher->type }}')">
                                        <div
                                            class="grid gap-1 p-2 border rounded-sm bg-light cursor-pointer  custom-shadow">
                                            <div class="flex">
                                                <p
                                                    class="text-[10px] md:text-[12px] lg:text-[12px] xl:text-[13px] text-[#183018] font-semibold">
                                                    {{ ucwords($voucher->type) }} - {{ ucwords($voucher->promo_name) }}
                                                </p>
                                            ...
                                            <div class="flex">
                                                @if ($voucher->discount)
                                                    @if ($voucher->discount >= 0 && $voucher->discount <= 100)
                                                        <p
                                                            class="text-[10px] md:text-[10px] lg:text-[11px] xl:text-[13px] text-[#183018]">
                                                            Diskon {{ $voucher->discount }}%</p>
                                                    @elseif ($voucher->discount >= 10000 && $voucher->discount <= 1000000)
                                                        <p
                                                            class="text-[10px] md:text-[10px] lg:text-[11px] xl:text-[13px] text-[#183018]">
                                                            Diskon Rp{{ number_format($voucher->discount, 0, ',', '.') }}
                                                        </p>
                                                    @else
                                            ...
                                            <div class="d-flex gap-1 gap-md-2 align-items-center">
                                                ...
                                                <p
                                                    class="text-[10px] md:text-[9px] lg:text-[11px] xl:text-[13px] text-[#183018]">
                                                    Berlaku hingga
                                                    {{ \Carbon\Carbon::parse($endDate)->translatedFormat('d F Y') }}
                                                </p>
                                                <a class="ml-auto text-[10px] md:text-[9px] lg:text-[11px] xl:text-[13px] text-danger text-decoration-none"
                                                    onclick="toggleDetail(event, '#detail-promo-{{ $voucher->id }}', this)">S&K</a>
                                            </div>

                                            <div class="grid mt-1 mt-md-3 detail-promo"
                                                id="detail-promo-{{ $voucher->id }}" style="display: none;">
                                                <p
                                                    class="text-[10px] md:text-[12px] lg:text-[12px] xl:text-[13px] text-black font-semibold">
                                                    Syarat & Ketentuan</p>
                                                <ol class="list-group-numbered overflow-y-auto custom-scroll"
                                                    style="max-height:100px;">
                                                    <li
                                                        class="list-group-item p-1 border-none d-flex align-items-start text-[10px] md:text-[10px] lg:text-[9px] xl:text-[11px]">
                                                        <p
                                                            class="ml-2 text-[10px] md:text-[10px] lg:text-[9px] xl:text-[11px] mb-0">
                                                            Minimal transaksi sebesar
                                                    ...
                                                    <li
                                                        ...
                                                        <p
                                                            class="ml-2 text-[10px] md:text-[10px] lg:text-[9px] xl:text-[11px] mb-0">
                                                            Maksimal pembelian {{ $voucher->max_quantity_buyer }} jenis
                                                            produk</p>
                                                    </li>
                                                    @if ($voucher->brand_id !== null)
                                                        <li
                                                            ...
                                                            <p
                                                                class="ml-2 text-[10px] md:text-[10px] lg:text-[9px] xl:text-[11px] mb-0">
                                                                Khusus pembelian product brand {{ $voucher->brand_name }}
                                                            </p>
                                                        </li>
                                                    @endif
                            ...
                            @if ($unusableVouchers->isNotEmpty())
                                <h5
                                    class="text-[#183018] text-[12px] md:text-[10px] lg:text-[11px] xl:text-[13px] mt-1 mt-md-0 font-semibold mb-1">
                                    Voucher tersedia</h5>
                                @foreach ($unusableVouchers as $voucher)
                                    <div class="col-12 p-1 p-md-2 promo-item" onclick="event.stopPropagation()">
                                        <div
                                            ...
                                            <div class="flex">
                                                <p
                                                    class="text-[10px] md:text-[12px] lg:text-[12px] xl:text-[13px] text-muted font-semibold">
                                                    {{ ucwords($voucher->type) }} - {{ ucwords($voucher->promo_name) }}
                                                </p>
                                                <i class="fas fa-check hidden ml-auto"></i>
                                            </div>
                                            ...
                                            <div>
                                                @if ($voucher->discount)
                                                    @if ($voucher->discount >= 0 && $voucher->discount <= 100)
                                                        ...
                                                        <p
                                                            class="text-[10px] md:text-[10px] lg:text-[11px] xl:text-[13px]">
                                                            Diskon {{ $voucher->discount }}%</p>
                                                    @elseif ($voucher->discount >= 10000 && $voucher->discount <= 1000000)
                                            ...
                                            <div>
                                                @if ($voucher->type !== 'ongkir voucher')
                                                    @if ($data['voucherDisabled'] == true)
                                                        <p
                                                            class="text-[10px] md:text-[10px] lg:text-[9px] xl:text-[11px] text-danger">
                                                            - Voucher tidak bisa digunakan bersama dengan promo produk
                                                            lainnya</p>
                                                    @endif
                                                @endif
                                                ...
                                                @if ($data['totalPrice'] < $voucher->min_transaction)
                                                    <p
                                                        class="text-[10px] md:text-[10px] lg:text-[9px] xl:text-[11px] text-danger">
                                                        - Oops.. Kurang
                                                        Rp{{ number_format($voucher->min_transaction - $data['totalPrice'], 0, ',', '.') }}
                                                        lagi</p>
                                                @endif
                                                ...
                                                @if ($data['totalItem'] > $voucher->max_quantity_buyer)
                                                    <p
                                                        class="text-[10px] md:text-[10px] lg:text-[9px] xl:text-[11px] text-danger">
                                                        - Jumlah produk yang kamu beli melebihi S&K voucher ini</p>
                                                @endif

                                                @if ($voucher->type == 'brand voucher')
                                                    <p
                                                        class="text-[10px] md:text-[10px] lg:text-[9px] xl:text-[11px] text-danger">
                                                        - Hanya bisa digunakan untuk produk brand
                                                        {{ $voucher->brand_name }}</p>
                                                @endif

                                                @if ($voucher->type == 'product voucher')
                                                    <p
                                                        class="text-[10px] md:text-[10px] lg:text-[9px] xl:text-[11px] text-danger">
                                                        - Tidak bisa digunakan untuk produk yang kamu beli</p>
                                                @endif
                                            </div>

                                            <div class="grid mt-3 detail-promo" id="detail-promo-{{ $voucher->id }}"
                                                style="display: none;">
                                                <p
                                                    class="text-[10px] md:text-[12px] lg:text-[12px] xl:text-[13px] text-black font-semibold">
                                                    Syarat & Ketentuan</p>
                        ...
                        @else
                            <div style="display:flex; align-items:center; justify-content:start;">
                                ...
                                <p class="text-danger text-[12px] md:text-[10px] lg:text-[12px] xl:text-[13px]">Maaf tidak
                                    ada voucher tersedia</p>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                @if (count($data['vouchers']) !== 0)
                    <div class="modal-footer flex bg-[#183018] py-1">
                        <div class="grid">
                            <p class="text-white text-[9px] md:text-[10px] lg:text-[10px] xl:text-[12px] d-none"
                                id="hore">Yeyy.. Kamu hemat,</p>
                            <p class="text-white text-[9px] md:text-[10px] lg:text-[10px] xl:text-[12px]" id="thrifty">
                            </p>
                        </div>
                        <div class="grid">
                            <p class="text-[#183018] text-[9px] md:text-[10px] lg:text-[10px] xl:text-[12px]"
                                id="discountPrice"></p>
                            <p class="text-[#183018] text-[9px] md:text-[10px] lg:text-[10px] xl:text-[12px]"
                                id="ongkirPrice"></p>
                        </div>
                        <div class="ml-auto">
                            ...
                            <button type="button"
                                class="btn bg-white text-[#183018] rounded-sm text-[12px] md:text-[10px] lg:text-[12px] xl:text-[13px]"
                                id="choose-voucher" data-bs-dismiss="modal">Gunakan</button>
                        </div>
                    </div>
                @endif
            </div>
