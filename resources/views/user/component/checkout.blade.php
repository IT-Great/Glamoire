...
@section('content')
    ...
    <div class="md:px-20 lg:px-24 xl:px-24 2xl:px-48 pt-4 pb-5">
        ...
        <div class="container-fluid">
            ...
            <h1 class="page-title px-md-3">Checkout</h1>
        </div>
    ...
    <script>
        ...
        document.addEventListener('change', function (e) {
            if (e.target && e.target.id === 'checkout_province') {
                const provinceId = e.target.value;
                document.getElementById("checkout_province_name").value = e.target.options[e.target.selectedIndex].text;
                const regencySelect = document.getElementById("checkout_regency");
                regencySelect.innerHTML = '<option value="">Pilih Kabupaten/Kota</option>';
                document.getElementById("checkout_district").innerHTML = '<option value="">Pilih Kecamatan</option>';
                document.getElementById("checkout_subdistrict").innerHTML = '<option value="">Pilih Desa</option>';
            ...
            } else if (e.target && e.target.id === 'checkout_regency') {
                const regencyId = e.target.value;
                document.getElementById("checkout_regency_name").value = e.target.options[e.target.selectedIndex].text;
                const distSelect = document.getElementById("checkout_district");
            ...
            } else if (e.target && e.target.id === 'checkout_district') {
                const distId = e.target.value;
                document.getElementById("checkout_district_name").value = e.target.options[e.target.selectedIndex].text;
                const subSelect = document.getElementById("checkout_subdistrict");
            ...
            } else if (e.target && e.target.id === 'checkout_subdistrict') {
                document.getElementById("checkout_subdistrict_name").value = e.target.options[e.target.selectedIndex].text;
            }
        });
    </script>
