                        ...
                        @if ($checkout_address->is_use)
                            <div
                                ...
                                <div class="grid gap-1 gap-md-2 mb-md-2">
                                    ...
                                    <div class="d-flex">
                                        <button type="button"
                                            class="btn rounded-sm text-white text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px] bg-[#183018] hover:bg-neutral-900"
                                ...
                                <div class="modal-body overflow-y-auto" style="max-height:100vh;">
                                    <form method="POST" action="{{ route('add.shipping.address') }}"
                                        ...
                                        <div class="grid gap-1 gap-md-2">
                                            ...
                                            <div class="col-12 p-0">
                                                <button
                                                    class="btn btn-primary w-full rounded-sm text-white text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px] bg-[#183018] hover:bg-neutral-900"
                    ...
                    <div
                        ...
                        <div class="grid gap-1 gap-md-2 mb-md-2">
                            ...
                            <div class="flex gap-1 align-items-center">
                                ...
                                <p class="text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px] text-[#183018]">Berat
                                    Produk :
                                    @if ($data['weight'] < 1000)
                                        {{ $data['weight'] }}gr
                                    @else
                            ...
                            <div class="flex gap-1 align-items-center">
                                ...
                                <p class="text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px] text-[#183018]">Tarif
                                    Pengiriman :</p>
                                <p class="text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px] text-[#183018]"
                                    id="shipping_price"></p>
                            </div>
                    ...
                    <div class="p-3 bg-light rounded shadow-sm border border-[#183018] grid gap-2 gap-md-2">
                        ...
                        <div>
                            <div class="relative flex gap-1 items-center input-code">
                                ...
                                <input type="text"
                                    class="form-control pl-5 w-full rounded-sm text-[12px] md:text-[10px] lg:text-[12px] xl:text-[14px]"
                                ...
                                <button type="button" id="button-code-voucher"
                                    class="btn border rounded-sm w-fit text-white text-[12px] md:text-[10px] lg:text-[12px] xl:text-[14px] hover-shadow-md"
                        ...
                        <button type="button"
                            ...
                            id="show-voucher">
                            <i
                                class="fas fa-solid fa-tag mr-2 text-[12px] md:text-[10px] lg:text-[12px] xl:text-[14px]"></i>
                            <p class="text-[12px] md:text-[10px] lg:text-[12px] xl:text-[14px]" id="choose-voucher">Pilih
                                Voucher</p>
                            <i
                                class="fas fa-solid fa-arrow-right ml-auto text-[12px] md:text-[10px] lg:text-[12px] xl:text-[14px]"></i>
                        </button>
                        <button
                            class="hover:cursor-pointer py-2 text-decoration-none rounded-sm hover:bg-neutral-900 shadow-sm px-3 text-white bg-[#183018] w-full text-[12px] md:text-[12px] lg:text-[12px] xl:text-[14px]"
                            id="paynow">
                            Bayar Sekarang
                        </button>
                    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    Toast.fire({
                        ...
                        location.href = response.user_id +
                            "_account"; // Redirect ke halaman utama atau halaman lain
                    });
                },
                complete: function() {
                    $('.loading-container').hide(); // Show the spinner
        ...
        <div class="modal-dialog">
            <div class="modal-content overflow-y-auto" style="max-height:90vh;">
                <div class="modal-header border-none pb-0">
                    <h1 class="modal-title text-[12px] md:text-[12px] lg:text-[14px] xl:text-[16px]"
            ...
            <div class="modal-content overflow-y-auto" style="max-height:90vh;">
                <div class="modal-header border-none bg-[#183018]">
                    <div class="flex gap-3 justify-content-center align-items-center">
                        ...
                        <h1 class="modal-title text-white text-[12px] md:text-[10px] lg:text-[12px] xl:text-[14px]">Gunakan
                            Voucher Promo</h1>
                    </div>
                </div>
                    ...
                    <div class="col-12 p-0">
                        ...
                        @if (count($data['vouchers']) !== 0)
                            ...
                            @if ($usableVouchers->isNotEmpty())
                                ...
                                @foreach ($usableVouchers as $voucher)
                                    <div class="col-12 p-0 p-md-2 promo-item" data-code="{{ $voucher->promo_code }}"
                                        ...
                                        <div
                                            ...
                                            <div class="flex">
                                                <p
                                                    class="text-[10px] md:text-[12px] lg:text-[12px] xl:text-[14px] text-[#183018] font-semibold">
                                            ...
                                            <div class="grid mt-1 mt-md-3 detail-promo"
                                                ...
                                                <p
                                                    class="text-[10px] md:text-[12px] lg:text-[12px] xl:text-[14px] text-black font-semibold">
                                                    Syarat & Ketentuan</p>
                                ...
                                @foreach ($unusableVouchers as $voucher)
                                    <div class="col-12 p-0 p-md-2 promo-item" onclick="event.stopPropagation()">
                                        <div
                                            ...
                                            <div class="flex">
                                                <p
                                                    class="text-[10px] md:text-[12px] lg:text-[12px] xl:text-[14px] text-muted font-semibold">
                                                    {{ ucwords($voucher->type) }} - {{ ucwords($voucher->promo_name) }}
                                                </p>
                                                <i class="fas fa-check hidden ml-auto"></i>
                                            </div>
                                            ...
                                            <div>
                                                @if ($data['voucherDisabled'] = true)
                                                    <p
                                                        ...
                                                        - Voucher tidak bisa digunakan bersama dengan promo produk lainnya
                                                    </p>
                                                @endif
                        ...
                        @else
                            <div style="display:flex; align-items:center; justify-content:start;">
                                ...
                                <p class="text-danger text-[12px] md:text-[10px] lg:text-[12px] xl:text-[14px]">Maaf tidak
                ...
                @if (count($data['vouchers']) !== 0)
                    <div class="modal-footer flex">
                        ...
                        <div class="ml-auto">
                            ...
                            <button type="button"
                                class="btn btn-success rounded-sm text-[12px] md:text-[10px] lg:text-[12px] xl:text-[14px]"
