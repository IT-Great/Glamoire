            ...
            <div class="row g-4 g-lg-5">
                ...
                <div class="col-lg-7">
                    ...
                    @else
                        ...
                        <p id="quantity-warning" class="mb-3 text-danger fs-7 d-none"><i class="fas fa-info-circle"></i> Batas
...
@section('content')
    <style>
        ...
        .product-main-title {
            font-family: 'Poppins', sans-serif; /* Dikembalikan ke font standar yang clean */
            font-size: 2.2rem;
            font-weight: 700;
            color: var(--text-main);
            line-height: 1.2;
            ...
            <div class="row g-4 g-lg-5">
                ...
                <div class="col-lg-7">
                    ...
                    @else
                        ...
                        <p id="quantity-warning" class="mb-3 text-danger fs-7 d-none"><i class="fas fa-info-circle"></i> Batas maksimal stok terpenuhi</p>
                    @endif
