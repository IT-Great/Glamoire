...
<div class="md:px-20 lg:px-24 xl:px-24 2xl:px-48 pt-2 py-2">
  ...
  <div class="container-fluid mb-2 mb-md-4">
    <div class="grid gap-2 mt-1 mt-md-2 mb-2 mb-md-4">
      <h1 class="text-black font-semibold text-[14px] md:text-[18px] lg:text-[24px] xl:text-[28px]">Kembangkan Brand Anda bersama kami.</h1>
      <p class="text-[10px] md:text-[12px] lg:text-[14px] xl:text-[16px]">Glamoire telah menjadi inkubator industri kecantikan dan perawatan pribadi terbaik di Indonesia, oleh karena itu, kami siap membantu mengembangkan brand Anda!</p>
    </div>  
        ...
        <form id="business-partner-form" method="POST" action="{{ route('partnership')}}" enctype="multipart/form-data">
          ...
          <div class="grid gap-1 gap-md-1">
            <div class="col-12 px-0 px-md-2">
              ...
              <input type="text" class="form-control rounded-sm text-[10px] md:text-[12px] lg:text-[14px] xl:text-[16px]" id="partner_fullname" name="partner_fullname" placeholder="Masukkan Nama Pengirim" required>
            </div>
            <div class="col-12 px-0 px-md-2">
            ...
            <div class="col-12 px-0 px-md-2">
              ...
              <input type="email" class="form-control rounded-sm text-[10px] md:text-[12px] lg:text-[14px] xl:text-[16px]" id="partner_email" name="partner_email" placeholder="Masukkan Alamat Email" required>
            </div>
            <div class="col-12 px-0 px-md-2">
              ...
              <input type="text" class="form-control rounded-sm text-[10px] md:text-[12px] lg:text-[14px] xl:text-[16px]" id="company" name="company" placeholder="Masukkan Nama PT/CV/Brand" required>
            </div>
            <!-- DESCRIPTION -->
            <div class="col-12 px-0 px-md-2">
            ...
            <div class="col-12 flex gap-1 gap-md-6">
              ...
              <div class="col-6">
                <div class="form-check form-check-inline">
                  <input class="form-check-input text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]" type="radio" name="bpom" id="bpom_yes" value="yes" required>
                  <label class="form-check-label text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]" for="bpom">Ada</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]" type="radio" name="bpom" id="bpom_no" value="no" required>
                  <label class="form-check-label text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]" for="bpom">Tidak</label>
                </div>
              </div>
            </div>
            <!-- BPOM CERTIFICATE -->
            ...
            <div class="col-12 flex gap-1 gap-md-6">
              ...
              <div class="col-6">
                <div class="form-check form-check-inline">
                  <input class="form-check-input text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]" type="radio" name="distributor" id="distributor_yes" value="yes" required>
                  <label class="form-check-label text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]" for="genderMale">Ada</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]" type="radio" name="distributor" id="distributor_no" value="no" required>
                  <label class="form-check-label text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]" for="genderFemale">Tidak</label>
                </div>
              </div>
            </div>
            <!-- RECEIVE EMAIL -->
            <div class="col-12 flex gap-1 gap-md-6">
              ...
              <div class="col-6">
                <div class="form-check form-check-inline">
                  <input class="form-check-input text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]" type="radio" name="receive_email" id="receive_email_yes" value="yes" required>
                  <label class="form-check-label text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]" for="genderMale">Pernah</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]" type="radio" name="receive_email" id="receive_email_no" value="no" required>
                  <label class="form-check-label text-[10px] md:text-[10px] lg:text-[12px] xl:text-[14px]" for="genderFemale">Belum</label>
                </div>
              </div>
            </div>
            <!-- CATEGORY PRODUCT -->
            <div class="col-12 px-0 px-md-2">
              ...
              <input type="text" class="form-control rounded-sm text-[10px] md:text-[12px] lg:text-[14px] xl:text-[16px]" id="category_product" name="category_product" placeholder="Skincare / Alat Make Up dan lain sebagainya">
            </div>
