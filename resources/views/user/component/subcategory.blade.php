  ...
  <div class="container-fluid px-0 px-md-3">
    <div class="shadow-sm border border-black rounded-sm py-2 py-md-3 my-2 my-md-3 px-0 px-md-3">
      <div class="d-flex gap-1 px-3 px-md-0">
        ...
        <p class="text-[10px] md:text-[12px] lg:text-[12px] xl:text-[14px]"> > </p>
        <a href="/belanja-{{$category}}" class="text-[10px] md:text-[12px] lg:text-[12px] xl:text-[14px]">{{ ucwords(strtolower($category)) }}</a>
        <p class="text-[10px] md:text-[12px] lg:text-[12px] xl:text-[14px]"> > </p>
        <a href="/belanja-{{$category}}-{{$subcategory}}" class="text-black text-[10px] md:text-[12px] lg:text-[12px] xl:text-[14px]">{{ $subcategory }}</a>
      </div>
    </div>
  </div>
        ...
        <div class="border border-black shadow-md rounded-sm md:mb-0 lg:mb-0 xl:mb-0 py-1 px-3">
          ...
          <form action="{{ route('shop.category.sub', ['category' => $category, 'subcategory' => $subcategory]) }}" method="GET" id="form-filter-subcategory">
            ...
            <div class="border-bottom pb-2">
              <h5 class="font-weight-semi-bold text-[#183018] mb-2 text-[7px] md:text-[9px] lg:text-[10px] xl:text-[12px]">{{ ucwords(strtolower($category)) }}</h5>
                @foreach ($subCategories as $subCategory)
                  <a href="{{ route('shop.category.sub', ['category' => $category, 'subcategory' => $subCategory->name]) }}" class="pb-1 text-[7px] md:text-[9px] lg:text-[10px] xl:text-[11px] d-flex align-items-center justify-content-between">
                    {{ $subCategory->name }}
            ...
            <div>
              <button class="btn text-[10px] md:text-[10px] lg:text-[10px] xl:text-[12px] text-white border w-full rounded-sm mb-2" type="submit" id="useFilter"  style="background-color: #183018">
                Gunakan Filter
              </button>
              <button class="btn btn-danger text-[10px] md:text-[10px] lg:text-[10px] xl:text-[12px] text-white border w-full rounded-sm mb-2" type="button" id="resetFilter" onclick="resetFilters()">
                Reset Filter
              </button>
            </div>
        </div>
                  ...
                  @if (session('id_user'))
                    ...
                    @else
                      <div style="min-height:48vh;">
                        ...
                        <div style="display:flex; align-items:center; justify-content:center;">
                          <p class="text-danger text-[12px] md:text-[12px] lg:text-[14px] xl:text-[16px]">Maaf tidak ada produk di sub kategori ini</p>
                        </div>
                      </div>
                    @endif
  ...
  <div class="modal-dialog">
    <div class="modal-content overflow-y-auto custom-scroll" style="max-height:90vh;">
      <div class="modal-header" style="background-color: #183018">
        <h1 class="modal-title text-white text-[14px]" id="exampleModalLabel">Form Filter Produk</h1>
              ...
              <div>
                <div class="price-range-container">
                  <div>
                    ...
                    <span id="min-price-value-mobile" class="text-[10px] md:text-[10px] lg:text-[10px] xl:text-[14px]">Rp{{ $minPrice !== null ?  number_format($minPrice, 0, ',', '.') : 0 }}</span>
                  </div>
                  ...
                  <div>
                    ...
                    <span id="max-price-value-mobile" class="text-[10px] md:text-[10px] lg:text-[10px] xl:text-[14px]">Rp{{ $minPrice !== null ?  number_format($maxPrice, 0, ',', '.') : '1.000.000' }}</span>
                  </div>
      ...
      <div class="modal-footer">
        <div class="w-full">
          <button class="btn text-[14px] md:text-[10px] lg:text-[12px] xl:text-[14px] text-white border w-full rounded-sm mb-2" type="submit" id="useFilterMobile"  style="background-color: #183018">
            Gunakan Filter
          </button>
          <button class="btn bg-danger text-[14px] md:text-[10px] lg:text-[12px] xl:text-[14px] text-black border w-full rounded-sm mb-2" type="submit" id="resetFilterMobile" onclick="resetFilter()">
            Reset Filter
          </button>
        </div>
        </form>
