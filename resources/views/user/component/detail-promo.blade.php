...
@section('content')
  <style>
      ...
      /* [PERBAIKAN] Menetapkan font-family standar untuk nama produk */
      .product-name-clamp {
            display: -webkit-box;
            -webkit-line-clamp: 3;
            -webkit-box-orient: vertical;
            ...
            transition: color 0.2s;
            margin-bottom: 0.5rem;
            font-family: 'Poppins', -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; /* Mengamankan font default */
        }
