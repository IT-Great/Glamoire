...
@section('content')
                                        ...
                                        <div class="order-footer">
                                            ...
                                            <div class="order-actions">
                                                ...
                                                @if ($order->status == 'completed')
                                                    ...
                                                    @php
                                                        // Menyusun data keranjang dengan memetakan item pesanan
    ...
    <script>
        ...
        $(document).ready(function() {
            // === LOGIKA TOMBOL BELI LAGI (AJAX PROMISE.ALL) ===
            $('.btn-beli-lagi').on('click', function(e) {
                ...
                let promises = items.map(item => {
                    // Tentukan URL berdasarkan apakah produk memiliki varian atau tidak
                ...
                Promise.all(promises)
                    .then(responses => {
                        Swal.fire({
                            ...
                            window.location.href = "/cart"; // Arahkan pengguna ke keranjang
                        });
                    })
                    .catch(err => {
                        console.error(err);
...
@section('content')
    ...
    <style>
        ...
        .order-item-row {
            display: flex;
            flex-wrap: wrap; /* Memungkinkan elemen turun ke bawah di mobile */
            gap: 1.5rem;
            margin-bottom: 1.5rem;
            padding-bottom: 1.5rem;
            border-bottom: 1px dashed var(--border-color);
                    ...
                    <div class="modal-body p-4 custom-scroll" style="max-height: 75vh; overflow-y: auto;">
                        <form method="POST" action="{{ route('edit.shipping.address') }}">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label text-dark">Provinsi</label>
                                    <select class="form-select" name="province_change" id="province_change_{{ $sa->id }}" required>
                                        <option value="{{ $sa->id_province }}" selected>{{ $sa->province }}</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label text-dark">Kota/Kabupaten</label>
                                    <select class="form-select" name="regency_change" id="regency_change_{{ $sa->id }}" required>
                                        <option value="{{ $sa->regency }}" selected>{{ $sa->regency }}</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label text-dark">Kecamatan</label>
                                    <select class="form-select" name="district_change" id="district_change_{{ $sa->id }}" required>
                                        <option value="{{ $sa->district }}" selected>{{ $sa->district }}</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label text-dark">Desa/Kelurahan</label>
                                    <select class="form-select" name="subdistrict_change" id="subdistrict_change_{{ $sa->id }}" required>
                                        <option value="{{ $sa->subdistrict }}" selected>{{ $sa->subdistrict }}</option>
                                    </select>
...
@section('content')
    ...
    <style>
        ...
        .user-avatar {
            ...
            color: var(--glamoire-dark);
            font-family: 'The Seasons', serif;
            overflow: hidden; /* Added to clip the image properly */
        }
...
@section('content')
    ...
    <style>
        ...
        .wishlist-card:hover .wishlist-action {
            background: var(--glamoire-dark);
            color: #FFF;
            border-color: var(--glamoire-dark);
            box-shadow: 0 4px 15px rgba(24, 48, 24, 0.2);
                                        ...
                                        <div class="col-6 col-md-4 col-xl-3">
                                            <div class="wishlist-card"
                                                ...
                                                <div class="wishlist-img-box">
                                                    <button class="wishlist-remove-btn" title="Hapus dari Favorit"
                                                        onclick="event.stopPropagation(); removeFromWishlist('{{ $wp->id }}');">
                                                        <i class="fas fa-trash-alt"></i>
                                                    </button>
...
@section('content')
    ...
    <script>
        ...
        function updateTimers() {
            $('.countdown-timer').each(function() {
                ...
                let expiry = new Date(expiryData).getTime();
                ...
                if (distance < 0) {
                    ...
                    $(this).find('.time-left').text(minutes + ":" + seconds);
                }
            });
        }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadVillages(distId, addressId) {
                const subSelect = document.getElementById("subdistrict_change_" + addressId);
                const selectedSubName = subSelect.getAttribute('data-selected-name');
