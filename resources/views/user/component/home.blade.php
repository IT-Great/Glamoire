...
<div class="md:px-20 lg:px-24 xl:px-48 2xl:px-96 py-2">
    ...
    <div class="container-fluid">
        <div class="text-center py-3">
            <h2 class="section-title px-5 text-[16px] md:text-[14px] lg:text-[16px] xl:text-[18px]"><span class="px-2">Produk Terbaru</span></h2>
        </div>
                        ...
                        <div class="bg-white rounded-lg shadow-sm overflow-hidden h-fit ">
                            <a href="/{{ $product->product_code }}_product" class="text-decoration-none">
                                ...
                                <div class="grid gap-1 text-left p-1 p-md-2">
                                    ...
                                    <p class="text-decoration-none text-black text-[9px] md:text-[12px] lg:text-[10px] xl:text-[12px] overflow-hidden">
                                        <a href="/{{ $product->product_code }}_product" 
                                        class="text-decoration-none truncate-ellipsis" 
                                        data-bs-toggle="tooltip" 
                                        data-bs-placement="top" 
    ...
    <!-- KEUNGGULAN -->
    <div class="container-fluid my-2 my-md-4 my-lg-6 my-xl-8">
        <div class="row px-3">
            <div class="col-4 p-0">
