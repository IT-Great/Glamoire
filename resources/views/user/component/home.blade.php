...
@section('content')
    ...
    <style>
        ...
        .mySwiperCarousel .swiper-slide img {
            ...
            display: block;
            /* Penting untuk menghilangkan gap */
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body p-0">
                            ...
                            <!-- Fullscreen image -->
                            <div class="container-fluid p-0 m-0">
                                <img src="{{ Storage::url($data['popup']->image_popup) }}" alt="Gambar Subscribe"
                                    class="product-img img-fluid w-auto h-100">
                                <div class="d-flex gap-2">
                                    <div class="py-2 flex col-12 align-items-center justify-content-center"
                                        ...
                                        <div class="col-6 m-0 p-0">
                                            <form class="grid gap-1 gap-md-2" id="voucher-form">
                                                ...
                                                <div class="relative flex items-center">
                                                    ...
                                                    <!-- Ikon Email -->
                                                    <input type="email"
                                                        class="form-control pl-10 pr-10 rounded-md text-[10px] md:text-[9px] lg:text-[10px] xl:text-[11px]"
                                                ...
                                                <button
                                                    class="py-2 w-full rounded-md text-white bg-[#183018] hover:bg-neutral-900 text-[10px] md:text-[9px] lg:text-[10px] xl:text-[11px]"
    ...
    <div class="md:px-20 lg:px-24 xl:px-24 2xl:px-48 py-2">
        ...
        <div class="container-fluid">
            <div class="text-center py-3">
                <h2 class="section-title px-5 text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]"><span
                    ...
                    <div class="col-6 col-md-4 p-0 p-md-2">
                        <form class="grid gap-1 gap-md-2 m-0" id="subscribe-form">
                            ...
                            <div class="relative flex items-center">
                                ...
                                <!-- Ikon Email -->
                                <input type="email" name="emailVoucherNewUser"
