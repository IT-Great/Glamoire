...
@section('content')
    ...
    <div class="md:px-20 lg:px-24 xl:px-48 2xl:px-96 py-2">
        ...
        @else
            <div class="modal fade" id="firstUser" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
                data-bs-keyboard="false">
                                ...
                                <div class="d-flex gap-2">
                                    <div class="py-2 grid md:flex col-12 align-items-center justify-content-center"
                                        ...
                                        <div class="col-12 col-md-6 p-0 p-md-2 mb-2 mb-md-0">
                                            <p class="text-white text-[10px] md:text-[10px] lg:text-[10px] xl:text-[12px]">
                                                Dapatkan Kode Voucher Gratis Khusus Pengguna Baru</p>
                                        </div>
                                        <div class="col-12 col-md-6 m-0 p-0">
                                            <form class="grid gap-1 gap-md-2" id="voucher-form">
                                                @csrf
                                                <div class="relative flex items-center">
                                                    <i class="fas fa-envelope text-gray-400 absolute left-3"></i>
                                                    <!-- Ikon Email -->
                                                    <input type="email"
                                                        class="form-control pl-10 pr-10 rounded-md text-[8px] md:text-[9px] lg:text-[10px] xl:text-[11px]"
                                                        id="voucher_email" placeholder="Masukkan email" required>
                                                    <div class="spinner-border text-[#183018] absolute right-3"
                                                        role="status" style="width:15px; height:15px;display:none;">
                                                        <!-- Spinner -->
                                                ...
                                                <button
                                                    class="py-2 font-italic w-full rounded-md text-white bg-[#183018] text-[8px] md:text-[9px] lg:text-[10px] xl:text-[11px]"
                                                    type="submit" id="voucher-btn" disabled>Dapatkan Sekarang</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container-fluid p-0 m-md-4 m-lg-4 m-xl-4">
                                <a href="/{{ $promo->promo_name }}-detail-promo">
                                    <img src="{{ Storage::url($promo->image) }}" alt="{{ $promo->promo_name }}"
                                        title="{{ $promo->promo_name }}" class="img-fluid">
                                </a>
                            </div>
                        </div>
                    @endforeach
        ...
        <div class="container-fluid">
            <div class="text-center mb-2 md:mb-4 lg:mb-4 xl:mb-4 pt-1 md:pt-4 lg:pt-4 xl:pt-4">
                <h2 class="section-title px-5  text-[16px] md:text-[14px] lg:text-[16px] xl:text-[18px]"><span
                        class="px-2">Produk Terlaris</span></h2>
            </div>
                                ...
                                <div class="bg-white rounded-lg shadow-sm overflow-hidden product-item border border-xl">
                                    <a href="/{{ $product->product_code }}_product" class="text-decoration-none">
                                        <div class="product-image-container">
                                            <img class="card-img-top product-image {{ $product->stock_quantity == 0 ? 'dark-overlay' : '' }}"
                                        ...
                                        <div class="grid gap-1 text-left p-2">
                                            <div class="flex">
                                                <div class="flex gap-1">
                                                    <i class="text-decoration-none fas fa-star text-[8px] md:text-[10px] lg:text-[12px] xl:text-[14px]"
                                                        style="color:orange;"></i>
                                                    <p
                                                        class="text-decoration-none text-black text-[8px] md:text-[10px] lg:text-[12px] xl:text-[12px]">
            ...
            <p class="text-decoration-none text-black text-[8px] md:text-[10px] lg:text-[10px] xl:text-[14px]">
                <a href="/{{ $product->product_code }}_product" class="text-decoration-none" data-bs-toggle="tooltip"
        ...
        <div class="px-1 px-md-2">
            @if ($product->stock_quantity == 0)
                <a class="mb-2 py-2 rounded-sm border border-[#183018] shadow-sm w-full bg-danger text-decoration-none text-white p-0 text-[7px] md:text-[12px] lg:text-[10px] xl:text-[12px] flex align-items-center justify-content-center"
                    data-bs-toggle="tooltip" data-bs-placement="top" title="Beritahu Saya Jika Stok Sudah Ada"
                    type="button" style="color:#183018" id="notify-me-{{ $product->id }}"
            ...
            @else
                ...
                @if ($inCart)
                    <a href="/cart"
                        class="mb-2 py-2 rounded-sm border border-[#183018] shadow-sm w-full bg-[#183018] text-decoration-none text-white p-0 text-[7px] md:text-[12px] lg:text-[10px] xl:text-[12px] flex align-items-center justify-content-center hover-red">
                        Cek Keranjangmu
                    </a>
                @else
                    <a href="javascript:void(0);"
                        class="mb-2 py-2 rounded-sm border border-[#183018] hover:border-white shadow-sm w-full hover:bg-[#183018] text-decoration-none text-[#183018] hover:text-white p-0 text-[7px] md:text-[12px] lg:text-[10px] xl:text-[12px] flex align-items-center justify-content-center hover-red"
...
@else
    @foreach ($data['product'] as $product)
        <div class="swiper-slide p-0">
            <div
                class="border border-[#183018] bg-white rounded-lg shadow-sm overflow-hidden product-item d-flex flex-column transition-transform duration-300">
                <div class="product-image-container">
                    <img class="card-img-top product-image {{ $product->stock_quantity == 0 ? 'dark-overlay' : '' }}"
                        src="{{ Storage::url($product->main_image) }}" alt="{{ $product->product_name }}">
                </div>
    ...
    <div class="ml-auto">
        <a title="Tambah ke Favorit" href="javascript:void(0);"
            class="text-decoration-none text-[#183018] p-0 text-[9px] md:text-[12px] lg:text-[10px] xl:text-[12px] grid align-items-center justify-content-between hover-red"
    ...
    <div class="px-1 px-md-2 mt-auto add-wishlist">
        ...
        @else
            <a href="javascript:void(0);"
                class="gap-1 mb-2 py-2 rounded-sm border border-[#183018] hover:border-white shadow-sm w-full hover:bg-[#183018] text-decoration-none text-[#183018] hover:text-white p-0 text-[7px] md:text-[12px] lg:text-[10px] xl:text-[12px] flex align-items-center justify-content-center hover-red"
                onclick="addToCart({{ $product->id }})">
                + <i class="fas fa-shopping-cart"></i> Keranjang
            </a>
        @endif
    ...
    <div class="container-fluid my-8 md:my-10 lg:my-12 xl:my-14">
        <div class="text-center mb-2 md:mb-4 lg:mb-4 xl:mb-4 pt-1 md:pt-4 lg:pt-4 xl:pt-4">
            <h2 class="section-title px-5 text-[18px] md:text-[14px] lg:text-[16px] xl:text-[18px]"><span
                    class="px-2">Produk Terbaru</span></h2>
        </div>
...
@else
    ...
    <div class="container-fluid my-8 md:my-10 lg:my-12 xl:my-14">
        <div class="row">
            <div class="col-4">
                ...
                <p class="text-[8px] md:text-[10px] lg:text-[12px] xl:text-[14px]">1st Plant-Based Beauty Commerce in
                    Indonesia</p>
            </div>
            <div class="col-4">
                <h6 class="text-[10px] mb-2 md:text-[14px] lg:text-[16px] xl:text-[18px]">BPOM Approved</h6>
                <p class="text-[8px] md:text-[10px] lg:text-[12px] xl:text-[14px]">Belanja produk kecantikan pasti asli
                    dari ratusan brand yang bersertifikasi BPOM.</p>
            </div>
            <div class="col-4">
                <h6 class="text-[10px] mb-2 md:text-[14px] lg:text-[16px] xl:text-[18px]">Plant-Based Beauty</h6>
                <p class="text-[8px] md:text-[10px] lg:text-[12px] xl:text-[14px]">One stop Plant-Based Beauty Beauty,
    ...
    <div class="container-fluid mb-4">
        <div class="d-flex gap-2">
            <div class="py-3 grid md:flex col-12 align-items-center justify-content-center rounded-sm"
                style="background-color: #475136">
                ...
                <div class="col-12 col-md-4 p-0 p-md-2">
                    <form class="grid gap-1 gap-md-2 m-0" id="subscribe-form">
                        ...
                        <div class="relative flex items-center">
                            ...
                            <!-- Ikon Email -->
                            <input type="email"
                                class="form-control pl-10 pr-10 rounded-sm text-[10px] md:text-[9px] lg:text-[10px] xl:text-[12px]"
                                id="subscribe_email" placeholder="Masukkan email" autocomplete="off" required>
                        ...
                        <div id="validationEmailSubscribe" class="text-[12px] md:text-[8px] lg:text-[10px] xl:text-[12px]"
                            style="display: none;">
                        </div>
                        <button
                            class="py-2 w-full rounded-sm text-white bg-[#183018] text-[10px] md:text-[9px] lg:text-[10px] xl:text-[12px]"
