                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Semua COA</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row mb-4 slide-in">
                    <div class="col-12 col-md-4 mb-3 mb-md-0">
                        <div class="stats-card stats-card-primary">
                            ...
                            <div class="stats-title">Total COA</div>
                            <h3 class="stats-number">{{ $totalCoa }}</h3>
                            <div class="mt-3">
                    ...
                    <div class="col-12 col-md-4 mb-3 mb-md-0">
                        <div class="stats-card stats-card-success">
                            ...
                            <div class="stats-title">Total Debit</div>
                            <h3 class="stats-number">Rp {{ number_format($totalDebit, 0, ',', '.') }}</h3>
                            <div class="mt-3">
                                <small class="d-flex align-items-center">
                                    <i class="bi bi-arrow-up-short me-1"></i>
                                    Saldo bertipe debit
                    ...
                    <div class="col-12 col-md-4">
                        <div class="stats-card stats-card-warning">
                            ...
                            <div class="stats-title">Total Kredit</div>
                            <h3 class="stats-number">Rp {{ number_format($totalCredit, 0, ',', '.') }}</h3>
                            <div class="mt-3">
                                <small class="d-flex align-items-center">
                                    <i class="bi bi-arrow-up-short me-1"></i>
                                    Saldo bertipe kredit
                                </small>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-header bg-white">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div>
                                        <h4 class="mb-2 d-flex align-items-center"><i
                                                class="bi bi-journal-bookmark-fill me-2"></i>Chart of Accounts
                                            Directory
                                        </h4>
                                        <p class="text-muted mb-0">Daftar seluruh akun dan kategori beserta saldo
                                            terkait.
                                        </p>
                                    </div>
                                ...
                                <div class="col-12 col-md-6 d-flex justify-content-md-end align-items-center">
                                    <a href="{{ route('create-chartofaccount') }}"
                                        class="btn btn-sm btn-primary mb-2 d-inline-flex align-items-center">
                                        <i class="bi bi-plus fs-6 me-1"></i> New COA
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($coas as $coa)
                                            <tr id="coa-item-{{ $coa->id }}">
                                                <td>
                                                    <span class="fw-bold">{{ $coa->coa_no }}</span>
                                                </td>
                                                <td>
                                                    {{ Str::limit($coa->name, 30, '...') }}
                                                </td>
                                                <td>
                                                    @php
                                                        $categoryClass = strtolower($coa->category->category_name);
                                                        $class = in_array($categoryClass, [
                                                            'asset',
                                                            'liability',
                                                            'equity',
                                                            'revenue',
                                                    ...
                                                    @endphp
                                                    <span
                                                        class="badge bg-light text-capitalize text-dark border {{ $class }}">
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <button
                                                            class="btn btn-sm btn-outline-danger delete-coa d-flex align-items-center"
                                                            data-id="{{ $coa->id }}">
                                            ...
                                            <tr>
                                                <td colspan="6">
                                                    <div class="empty-state py-4 text-center">
                                                        ...
                                                        <h5 class="empty-state-text">Tidak ada akun ditemukan</h5>
                                                        <p class="text-muted mb-0">Tambahkan akun untuk mulai mengelola
                                                            keuangan.</p>
                                                    </div>
                                                </td>
                                            </tr>
