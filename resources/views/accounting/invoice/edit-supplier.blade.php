                ...
                <div class="page-title" style="margin-bottom: 25px;">
                    <div class="row align-items-center">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h2 class="mb-3">Edit Data Supplier</h2>
                                    ...
                                    <div class="card-header bg-white">
                                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                                            <div>
                                                ...
                                                <p class="text-muted">Update formulir di bawah ini untuk
                                                    memperbarui data supplier yang sudah ada pada sistem.</p>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="form-group has-icon-left mb-4">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ old('accountnumber', $suppliers->accountnumber) }}">
                                                                <div class="form-control-icon">
                                                        ...
                                                        <div class="form-group has-icon-left mb-4">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ old('bank_name', $suppliers->bank_name) }}">
                                                                <div class="form-control-icon">
