        ...
        <div id="main">
            <div class="page-heading">
                ...
                <div class="finance-nav d-flex justify-content-start align-items-center gap-3 flex-wrap">
                    <a href="{{ route('create-transaction', ['type' => 'transfer']) }}" class="finance-nav-item active">
                        <i class="bi bi-arrow-left-right me-2"></i>Transfer
                    </a>
                    <a href="{{ route('create-transaction', ['type' => 'receive']) }}" class="finance-nav-item">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('store-transaction-transfer') }}"
